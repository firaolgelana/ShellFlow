  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background to-slate-50 px-4">
      <div className="w-full max-w-md">
        ...
        <div className="mb-6">
          <button className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-lg border border-border bg-card hover:bg-slate-50 transition-colors shadow-sm">
                  ...
                  {["weak", "medium", "strong"].map((level) => (
                    <div
                      ...
                      className={`h-1 flex-1 rounded-full transition-colors ${
                        passwordStrength === level || (passwordStrength === "strong" && level !== "weak")
